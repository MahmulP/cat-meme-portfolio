...
export const profile: Profile = {
  ...
  longBio: [
    ...
    'I joined PT. Indowebhost Kreasi as a Full Stack Developer in October 2025, building payroll and clinic modules for an enterprise ERP system serving a plantation (perkebunan) operation, and was promoted to Technical Lead in May 2026. As Technical Lead I now own the full ERP build across every module — payroll and clinic plus everything else as the scope grew — assigning work to the developer team, reviewing implementations, and keeping the architecture coherent module to module. The stack runs on Go Fiber with Huma for typed routes, Svelte on the frontend, Redis for caching, and a mix of MS SQL Server and PostgreSQL.',
